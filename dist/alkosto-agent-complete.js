...
function detectCategory(query) {
    ...
    if (lowerQuery.includes('tv') || lowerQuery.includes('televisor'))
        return 'televisor';
    if (lowerQuery.includes('celular') || lowerQuery.includes('móvil') || lowerQuery.includes('smartphone'))
        return 'celular';
    if (lowerQuery.includes('laptop') || lowerQuery.includes('computador') || lowerQuery.includes('portátil'))
        return 'computador';
...
function detectBudget(query) {
    ...
    if (lowerQuery.includes('económico') || lowerQuery.includes('barato')) {
        if (lowerQuery.includes('celular'))
            return 800000;
...
function generateNaturalResponse(query, toolData) {
...
export { createCompleteAlkostoAgent, detectCategory, detectBudget, detectBrand, generateNaturalResponse };
