...
class SophisticatedAlkostoAgent {
  ...
  private async processUserInputWithCategoryLogic(userMessage: string): Promise<{
...
- RESPONDE SOLO EN JSON VÁLIDO`;
  ...
  private async askCategorySpecificQuestion(): Promise<string> {
...
8. Máximo 300 palabras`;
  ...
  private getCategorySpecificRecommendationInstructions(): string {
