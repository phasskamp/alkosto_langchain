...
}), winston.format.errors({ stack: true }), winston.format.printf(({ level, message, timestamp, ...meta }) => {
...
export const agentLogger = {
    ...
    response: (input, output, duration, metadata) => {
    ...
    toolCall: (toolName, input, output, duration) => {
...
export const performanceLogger = {
    searchPerformance: (query, resultsCount, searchTime, cacheHit) => {
...
export const businessLogger = {
    productInterest: (products, query) => {
    ...
    conversionEvent: (eventType, data) => {
